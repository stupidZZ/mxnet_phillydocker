...
*/
#ifndef MXNET_OPERATOR_CONTRIB_MODULATED_DEFORMABLE_CONVOLUTION_OLD_INL_H_
#define MXNET_OPERATOR_CONTRIB_MODULATED_DEFORMABLE_CONVOLUTION_OLD_INL_H_
...
#include "../nn/im2col.h"
#include "./nn/modulated_deformable_im2col_old.h"
#include "../linalg.h"
...
namespace dmconv {
  enum ModulatedDeformableConvolutionOldOpInputs { kData, kOffset, kMask, kWeight, kBias };
  enum ModulatedDeformableConvolutionOldOpOutputs { kOut };
  enum ModulatedDeformableConvolutionOldOpResource { kTempSpace };
}

struct ModulatedDeformableConvolutionOldParam : public dmlc::Parameter<ModulatedDeformableConvolutionOldParam> {
  TShape kernel;
  TShape stride;
  TShape dilate;
  TShape pad;
  ...
  DMLC_DECLARE_PARAMETER(ModulatedDeformableConvolutionOldParam) {
...
class ModulatedDeformableConvolutionOldOp : public Operator {
 public:
  explicit ModulatedDeformableConvolutionOldOp(ModulatedDeformableConvolutionOldParam p) {
    this->param_ = p;
 ...
 private:
  ModulatedDeformableConvolutionOldParam param_;
...
Operator* CreateOp(ModulatedDeformableConvolutionOldParam param, int dtype,
  std::vector<TShape> *in_shape,
  std::vector<TShape> *out_shape,
  Context ctx);

#if DMLC_USE_CXX11
class ModulatedDeformableConvolutionOldProp : public OperatorProperty {
 public:
  ...
  OperatorProperty* Copy() const override {
    auto ptr = new ModulatedDeformableConvolutionOldProp();
    ptr->param_ = param_;
    return ptr;
  }

  std::string TypeString() const override {
    return "_contrib_ModulatedDeformableConvolutionOld";
  }
